...
#pragma warning restore CA1031
        ...
        public string[] GetSectionNames()
        {
            ...
            foreach (var line in lines)
            {
                ...
                if (trimed.StartsWith("[", StringComparison.Ordinal) && trimed.EndsWith("]", StringComparison.Ordinal))
                {
        ...
        public override string ToString() => ToArray().JoinNewLine();
        ...
        public static IniReader Parse(string name, string data, IniProperties properties = default) => new IniReader(name, data.SplitNewLine(), properties);
        ...
        /// <param name="properties">The data properties.</param>
        /// <returns>Returns a new <see cref="IniReader" /> instance.</returns>
        public static IniReader Parse(string name, byte[] data, IniProperties properties = default) => Parse(name, Encoding.UTF8.GetString(data), properties);
        ...
        public static IniReader Parse(string name, string[] lines, IniProperties properties = default) =>
            new IniReader(name, (string[]) lines.Clone(), properties);
        ...
        public bool ReadStruct<T>(string section, ref T item, bool throwEx = true)
            where T : struct
            => ReadStructFields(section, ref item, throwEx);
        ...
        public bool ReadObjectFields(string section, object container, bool throwEx = false)
        {
            ...
            foreach (var field in fields)
            {
                ...
                try
                {
                    var obj = field.FieldType.ConvertValue(value, Culture);
        ...
        public bool ReadObjectProperties(string section, object container, bool throwEx = false)
        {
            ...
            foreach (var property in properties)
            {
                ...
                try
                {
                    var obj = property.PropertyType.ConvertValue(value, Culture);
        ...
        public string ReadString(string section, string name, string defaultValue = null)
        {
            ...
            {
                result = defaultValue ?? throw new InvalidDataException($"Section [{section}] Setting {name} is unset!");
            }
        ...
        public bool ReadBool(string section, string name, bool? defaultValue = null)
        {
            ...
            if (!GetValue(section, name, ref result))
            {
                ...
                {
                    throw new InvalidDataException($"Section [{section}] Setting {name} is unset!");
                }

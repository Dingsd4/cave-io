...
namespace Cave.IO
{
    ...
    public struct DoubleStruct : IEquatable<DoubleStruct>
    {
        ...
        {
            var d = new DoubleStruct { UInt64 = value };
            return d.Double;
        }
        ...
        {
            var d = new DoubleStruct { Int64 = value };
            return d.Double;
        }
        ...
        {
            var d = new DoubleStruct { Double = value };
            return d.Int64;
        }
        ...
        /// <summary>The value as UInt64.</summary>
        [FieldOffset(0)]
        public ulong UInt64;

        /// <summary>The value as Int64.</summary>
        [FieldOffset(0)]
        public long Int64;

        /// <summary>The value as Double.</summary>
        [FieldOffset(0)]
